...
router.post("/login/with-password", passport.authenticate("local-login", {
...
router.get("/login/with-facebook/redirect", passport.authenticate("fb-login", {
    failureRedirect: "/login",
    failureMessage: true
}), authController.loginWithPassword);
...
router.get("/login/with-google/redirect", passport.authenticate("gg-login", {
    failureRedirect: "/login",
    failureMessage: true
}), authController.loginWithPassword);
...
router.post("/signup/with-password", passport.authenticate('local-signup', {
...
router.get("/signup/with-facebook/redirect", passport.authenticate("fb-signup", {
    failureRedirect: "/signup",
    failureMessage: true
}), authController.loginWithPassword);
...
router.get("/signup/with-google/redirect", passport.authenticate("gg-signup", {
    failureRedirect: "/signup",
    failureMessage: true
}), authController.signUp);
...
router.get("/email/send-verify", passport.authenticate('email_verify', {
    action: 'requestToken',
    failureRedirect: '/'
}), function (req, res) {
